...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", '-1001505131111'))
ASS_ID = int(getenv("ASS_ID", '1708010431'))
OWNER_ID = list(map(int, getenv('OWNER_ID', '').split()))
GROUP = getenv("GROUP", None)
DEVLOAR = getenv("DEVLOAR", None)
CHANNEL = getenv("CHANNEL", None)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "BANDA")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ahmedagnaby/90")
